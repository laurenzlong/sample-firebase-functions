...
/** Optional parameters for creating a DataSnapshot. */
export interface DataSnapshotOptions {
    /** Full path of the reference (e.g. 'users/alovelace'), default is database root. */
    refPath?: string;
...
/** Create a DataSnapshot for unit testing. */
export declare function makeDataSnapshot(
    /** Value of data for the snapshot. */
    val: string | Number | Boolean | Array<any> | Object, options?: DataSnapshotOptions): DataSnapshot;
